...
class UpdateGroupTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->group = Group::factory(['workspace_id' => $this->user->workspace_id])->create();
     ...
     * @test
     */
    public function user_must_have_permission_to_update_a_group()
    {
