...
class DetachMemberFromGroupTest extends TestCase
{
    use RefreshDatabase;
     ...
     * @test
     */
    public function user_can_detach_members_from_group()
    {
        /**
        ...
        $this->group->members()->attach($anotherUser->id);
    ...
    {
        $route = route('group.member.destroy', [
